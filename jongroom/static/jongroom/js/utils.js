...
function range(a,b){var res=[];for(let i=a;i<b;i++){res.push(i)}return res;}
...
function getsorted(x){
  return x.slice().sort( (x,y) => x-y );
}
function getsorted_rev(x){
...
function take_positions(li,positions){
...
function sort_correspond(li,sortfunc){
