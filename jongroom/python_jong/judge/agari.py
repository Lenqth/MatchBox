...
class TestAgari(unittest.TestCase):
    ...
    def test_knitted(self):
        self.assertEqual( True , agari_knitted( to_array(man="147",pin="28",sou="369",ji="1234567") ))

    def test_knitted_normal(self):
        self.assertEqual( True , agari_knitted_normal( to_array(man="147",pin="25811",sou="369567") ) )
...
#    print( contain_knit(knithand) )
    ...
    pprint( is_agari( string_to_array("147m3469p1258sSSG") ) )
    #unittest.main()
